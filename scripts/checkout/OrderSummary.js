...
export function renderOrderSummary() {
          ...
          <div class="cart-item-details-grid">
            ...
            <div class="cart-item-details">
              ...
              <div class="product-quantity">
                ...
                <button class="update-add" data-product-id="${matchingProduct.id}">+</button>
                <button class="update-remove" data-product-id="${matchingProduct.id}">-</button>
                </div>
  ...
  document.querySelectorAll(".update-add").forEach((add) => {
    add.addEventListener("click", () => {
      const productId = add.dataset.productId;
      increasingItems(productId);
      renderOrderSummary();
    });
  });

  document.querySelectorAll(".update-remove")
   .forEach((remove)=>{
    remove.addEventListener('click',()=>{
      const productId = remove.dataset.productId;
      decreasingItems(productId);
      renderOrderSummary();
    })
   })
